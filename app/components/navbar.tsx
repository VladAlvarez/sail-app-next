  ...
  return (
    <nav className='bg-[#0C3854] fixed w-dvw p-2 z-10 border-2 shadow-lg flex justify-between md:justify-start '>
      <Image
        ...
        placeholder='blur'
      />
      <button data-collapse-toggle="navbar-default" type="button" className="mr-5 bg-blue-100 inline-flex items-center p-2 w-12 h-12 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-default" aria-expanded="false">
        <span className="sr-only">Open main menu</span>
        <svg className="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 17 14">
            <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M1 1h15M1 7h15M1 13h15"/>
        </svg>
    </button>
      <div className='hidden md:flex gap-5 items-center flex-grow' id='navbar-default'>
        <Link href="/">Home</Link>
