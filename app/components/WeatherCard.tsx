...
export default function WeatherCard({
  ...
  return (
    <div className="weatherCard w-[13rem] p-4 flex flex-col text-white gap-4 transition ease-in-out bg-blue-500 hover:scale-[1.05] hover:bg-indigo-500 m-3 duration-300">
